...
async function errorText(response: Response) {
  ...
  return "Nie udało się wygenerować promocji";
}
    ...
    <div className="w-full rounded-2xl border border-violet-400/10 bg-violet-500/[.025] p-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          ...
          {result ? "Generuj ponownie" : "Wygeneruj promocję"}
        </button>
      </div>
      ...
      {result && (
        <div className="mt-3 space-y-3 border-t border-white/[.05] pt-3 text-xs">
          ...
          <div>
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                type="button"
                onClick={() => void copyText(result.caption)}
